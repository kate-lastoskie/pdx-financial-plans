...
Prepared for Kate and Lucas. This document applies standard home affordability rules of thumb to the $600,000-$800,000 Portland price range and cross-checks them against combined monthly cash flow, including child-rearing costs and the Seattle condo, using fixed inputs from `03-home-affordability/README.md`, `02-future-budget/README.md`, and `05-seattle-condo-decision/README.md`.

---

## 1. Inputs and Dependency Chain

Dollar figures below are sourced from the documents cited, for traceability.

**From `shared/assumptions.md`:**
- Combined gross annual household income: $308,520/year (Kate $165,000 + Lucas $143,520).
- Down payment: $200,000, held separately from the $70,000 emergency fund.
- Other debts: none significant; the Seattle condo's existing mortgage is addressed separately below.

**From `03-home-affordability/README.md`:**
- Section 1, net monthly income at the "Partial" (6% of gross) retirement-contribution level (see that document's Section 1 for Max/Minimal variants):
  - Both working: **$16,182/month**
  - Kate's income only: **$9,466/month**
  - Lucas's income only: **$8,438/month**
- Section 2: all-in monthly housing cost by price point, base mortgage rate 6.55% (Freddie Mac PMMS, week ending July 16, 2026), itemized P&I / property tax / insurance components, closing costs, and post-closing emergency fund balance.
...
**From `02-future-budget/README.md`, Part 2 (Child Budget):**

Model: eight phases across an 18-year window (2027-2044, Child A birth through age 17). Section 10 of Part 2 (Child Budget) is reproduced in full below:
...
- **Phase 1** (2027-2028, Child A infant only) is used as the "1 child" figure and **Phase 2** (2029-2030, peak overlap) as the "2 children" figure in Sections 3, 5, and 6 below. Phases 5-8 (elementary through teen years), evaluated in nominal dollars, exceed Phase 2's nominal figure by the time they occur, since inflation has compounded for longer (see Part 2, Child Budget, Section 9).
- Phase totals combine childcare/aftercare (Section 2), children's health insurance premium (Section 3), food (Section 4), clothing (Section 5), and entertainment/activities (Section 6, plus camps/sports/vacation from Section 7). Inflation assumptions: childcare 4.5%/year, other categories 3.0%/year (Section 8).
- Excludes housing/mortgage costs, the Seattle condo, and adult/household baseline living expenses (Section 11); those are covered by `03-home-affordability/README.md`, `05-seattle-condo-decision/README.md`, and Part 1 (Adult Budget) respectively.

**From `02-future-budget/README.md`, Part 1 (Adult Budget):**

Part 1 (Adult Budget) is an intentionally blank fillable template for adult-only household costs; it contains no populated figures. This document uses a placeholder adult baseline living estimate of $3,000/month (2026 dollars, 0-children basis). Once Part 1 is filled in, figures in this document should be recalculated using the actual adult budget instead of this placeholder. For nominal-dollar projections, this placeholder is inflated forward at 3.0%/year, the same general-inflation rate Part 2 (Child Budget) uses, since neither Part 1 nor Part 2 projects it forward on its own.

**From `05-seattle-condo-decision/README.md`:**
- Section 1: condo carrying cost, base case: PITI $2,017 + HOA $435 + maintenance reserve $283 = **$2,735/month**. This is the raw carrying cost of owning the unit, used here as a fixed monthly outflow (not the document's rental-adjusted net figure from Section 2).
...
- None of these ratios involve child-rearing costs.
...
- None of the three rules of thumb incorporate child-rearing costs or a second property's carrying cost. The combined cash-flow check in Section 3 shows where that omission matters most:
  ...
  - With 1 child, the combined cash flow is still positive at every price point in today's dollars ($2,098 to $3,764/month) and in nominal dollars at the start and end of Phase 1 ($1,702 to $3,570/month across both nominal tables).
  - With 2 children at peak overlap, the combined cash-flow picture narrows substantially: today's-dollars surplus is $185-$1,851/month across the price range, and at $800,000 the margin has essentially collapsed to a token surplus. In nominal dollars, by the **start** of the peak-overlap phase (2029), $750,000 and $800,000 are already negative (-$238 and -$655/month); by the **end** of the phase (2030), $700,000 joins them (-$181/month), leaving only $600,000 ($652) and $650,000 ($236) positive.
  - The 25%-of-net rule is the only one of the three rules of thumb that also flags $750,000 and $800,000 as exceeding its threshold, but it does so using housing cost alone, without reference to children or the condo; the direction of its signal (higher price points are tighter) agrees with the combined cash-flow check's direction, even though the two are not calculating the same thing. The combined cash-flow check flags a wider range of price points ($700,000-$800,000, depending on the dollar basis used) than the 25%-of-net rule does ($750,000-$800,000 only).
...
- Runway is highest for the 0-children, Kate's-income-only scenario at the lowest price point (161.4 months) and lowest for the 2-children, Lucas's-income-only scenario at the highest price point (6.5 months).
...
- At $800,000, the combined figure is close to zero at the base rate ($185/month) and turns negative at +100 basis points (7.55%, -$219/month); at +200 basis points it deepens to -$638/month.
- At $750,000, a 200 basis point rate increase pushes the combined figure negative as well (-$153/month).
- At $700,000 and below, the combined figure remains positive across the full rate-stress range shown, though the margin at $700,000 narrows to $333/month at +200 basis points.
