# Current Monthly Budget - Kate & Lucas
...
| Emergency fund | $ | |
| **House down payment fund (Portland)** | $ | |
| **Wedding fund** | $ | |
| Other investments | $ | |
...
---
*Next step once filled in: revisit monthly, and use `shared/` to note any assumptions here that should carry into the other exercises (future budget, home affordability, 2001 vs. 2026 comparison).*
